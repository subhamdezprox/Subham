        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-10 md:mb-14 reveal">
            ...
            <div className="flex flex-col items-start sm:items-end gap-2">
              <span className="font-serif italic text-brand-earth/50 text-[13px] md:text-[15px]">
                11 works across residential, institutional & consulting
              </span>
              <span className="font-sans text-[11px] uppercase tracking-[0.18em] text-brand-earth/70">
                Chennai · Delhi · Coimbatore
              </span>
            </div>
          </div>

          {/* ── Row 1: Asymmetric hero grid ── */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 mb-4">
            ...
            <div className="reveal group relative overflow-hidden rounded-[16px] lg:col-span-7 shadow-[0_24px_60px_rgba(31,31,31,0.10)]">
              <img
                src={clientProject1}
                alt="Shubham sustainable residence construction project Chennai"
                loading="lazy"
                decoding="async"
              ...
              <div className="absolute bottom-7 left-7 right-7">
                ...
                <h3 className="text-white text-[24px] md:text-[32px] font-serif leading-tight">Sustainable Residence</h3>
                <p className="text-white/70 text-[12px] mt-1.5">Rammed earth + passive cooling design</p>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 grid grid-rows-2 gap-4">
              <div className="reveal group relative overflow-hidden rounded-[16px] shadow-[0_24px_60px_rgba(31,31,31,0.10)]">
                <img
                  src={clientProject2}
                  alt="Shubham sustainable residence project exterior eco-friendly building"
                  loading="lazy"
                  decoding="async"
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  <span className="top-title text-[10px] !mb-1.5 opacity-80">Eco Construction</span>
                  <h3 className="text-white text-[18px] md:text-[22px] font-serif leading-tight">Eco-Friendly Exterior</h3>
                </div>
              </div>
              <div className="reveal group relative overflow-hidden rounded-[16px] shadow-[0_24px_60px_rgba(31,31,31,0.10)]">
                <img
                ...
                <div className="absolute bottom-5 left-5 right-5">
                  ...
                  <h3 className="text-white text-[18px] md:text-[22px] font-serif leading-tight">OHAA School Project</h3>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            {[
              { img: clientProject4, label: "Residential · Delhi",    title: "Delhi Construction",     alt: "Shubham Delhi residential construction project sustainable" },
              { img: clientDetail1,  label: "Natural Material",        title: "Material Craftsmanship", alt: "Shubham natural material detail craftsmanship construction" },
              { img: clientDetail2,  label: "Detail Work",             title: "Material Detail",        alt: "Shubham natural material detail sustainable finish" },
              { img: clientDetail3,  label: "Precision Craft",         title: "Design Precision",       alt: "Shubham construction craftsmanship detail sustainable build" },
            ].map((item, i) => (
              <div key={i} className="reveal group relative overflow-hidden rounded-[14px] shadow-[0_18px_45px_rgba(31,31,31,0.08)]">
                <img
                  src={item.img}
                  alt={item.alt}
                  loading="lazy"
                  decoding="async"
                  className="w-full h-[220px] md:h-[270px] object-cover transition-transform duration-700 group-hover:scale-[1.05]"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#1F1F1F]/70 via-transparent to-transparent" />
                <div className="absolute bottom-4 left-4 right-4">
                  <span className="top-title text-[9px] md:text-[10px] !mb-1 opacity-80">{item.label}</span>
                  <h3 className="text-white text-[15px] md:text-[18px] font-serif leading-tight">{item.title}</h3>
                </div>
              </div>
            ))}
          </div>

          {/* ── Row 3: Detail gallery strip ── */}
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3">
            {[
              { img: clientDetail4, label: "Sustainable Finish",  alt: "Shubham sustainable finish detail construction quality" },
              { img: clientDetail5, label: "Site Progress",       alt: "Shubham construction progress site work sustainable build" },
              { img: clientDetail6, label: "Construction",        alt: "Shubham site construction work detail eco-friendly" },
              { img: clientDetail7, label: "Project View",        alt: "Shubham project exterior view completed construction" },
            ].map((item, i) => (
              <div
                key={i}
                className={`reveal group relative overflow-hidden rounded-[10px] shadow-[0_12px_30px_rgba(31,31,31,0.07)] ${i === 3 ? "col-span-2 lg:col-span-4" : "lg:col-span-1"}`}
              >
                <img
                  src={item.img}
                  alt={item.alt}
                  loading="lazy"
                  decoding="async"
                  className="w-full h-[140px] md:h-[170px] object-cover transition-transform duration-700 group-hover:scale-[1.06]"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#1F1F1F]/60 via-transparent to-transparent" />
                <div className="absolute bottom-3 left-3 right-3">
                  <span className="text-white/90 text-[10px] md:text-[11px] font-medium uppercase tracking-[0.1em]">{item.label}</span>
                </div>
              </div>
            ))}
          </div>
